class ClientPath {
  static Uri temperature(int id, int count) {
    return Uri.parse(
        "http://10.0.2.2:8000/devices/$id/sensors/temperature/?count=$count");
  }

  static Uri humidity(int id, int count) {
    return Uri.parse(
        "http://10.0.2.2:8000/devices/$id/sensors/humidity/?count=$count");
  }

  static Uri lighting(int id, int count) {
    return Uri.parse(
        "http://10.0.2.2:8000/devices/$id/sensors/lighting/?count=$count");
  }
